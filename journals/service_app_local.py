...
from nosql import mongo_setup_local
...
def print_header():
    print('Welcome to Three-Point_Journal (local version)')
    print()


def config_mongo():
    mongo_setup_local.global_init_local()


def list_journals():
    pass
    # list all the journals
    db.three_point_journal.findDocuments()
    # list all the journals since the specified point
    # given_date = input("Search how long period do you want the list of journal?: ")
    # db.three_point_journal.find({'date': {'$lte:2022'}
